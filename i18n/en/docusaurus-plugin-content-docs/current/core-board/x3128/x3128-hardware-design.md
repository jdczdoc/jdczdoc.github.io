...
description: X3128开发板硬件 hardware design notes
---
...
X3128CV2Core Board采用5Vpower supply的方式，用户只需给第115、116、117pin供5V的直流电，Core Board即可以正常工作。另外，Core Board还有一些其他的电源pin，具体定义如下：
