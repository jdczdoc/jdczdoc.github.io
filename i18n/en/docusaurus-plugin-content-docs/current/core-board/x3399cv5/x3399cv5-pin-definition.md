...
| 17 | GPIO4_D4 | GPIO |  |
| 18 | ADC_IN2 | ADCinput |  |
| 19 | GPIO2_C4/ / SDIO0_D0/ / SPI5_RXD | GPIO or SDIO Interface or SPI Interface |  |
...
| 37 | VCC_RTC | RTCPower input | Power input2.5 to 3V |
| 38 | GPIO4_C2/ / PWM0 | GPIO or PWM0 |  |
| 39 | GPIO2_D4 | GPIO |  |
| 40 | GPIO4_D2 | GPIO |  |
| 41 | GPIO4_D5 | GPIO |  |
| 42 | VCC3V3_S5 | Vice 3.3VPower input | 3.3Vinput, current is not less than 300mA |
| 43 | GPIO4_C5/ / SPDIF_TX | GPIO or optical output |  |
| 44 | GPIO4_C3/ / UART2DBG_RX | GPIO or UART2 |  |
| 45 | GPIO4_C4/ / UART2DBG_TX | GPIO or UART2 |  |
| 46 | GPIO4_C0/ / I2C3_SDA/ / UART2_RX | GPIO or I2C3 data or UART2 |  |
| 47 | GPIO4_C1/ / I2C3_SCL/ / UART2_TX | GPIO or I2C3 clock or UART2 |  |
| 48 | GPIO4_C7/ / HDMI_CEC | GPIO or HDMI CECFunction |  |
...
| Pin No. | Signal | Type | Description |
| --- | --- | --- | --- |
| 51 | VCC3V3_SYS | Main 3.3VPower input | 3.3Vinput, power supply is not less than 4.3A |
| 52 | VCC3V3_SYS | Main 3.3VPower input | 3.3Vinput, power supply is not less than 4.3A |
| 53 | GND | ReferenceGround |  |
...
| 84 | GND | ReferenceGround |  |
| 85 | HDMI_TXCN | HDMIoutput interface |  |
| 86 | HDMI_TXCP | HDMIoutput interface |  |
| 87 | HDMI_TX0N | HDMIoutput interface |  |
| 88 | HDMI_TX0P | HDMIoutput interface |  |
| 89 | HDMI_TX1N | HDMIoutput interface |  |
| 90 | HDMI_TX1P | HDMIoutput interface |  |
| 91 | HDMI_TX2N | HDMIoutput interface |  |
| 92 | HDMI_TX2P | HDMIoutput interface |  |
...
| 107 | USB3_SSTXP | USB 3.0 interface | TYPEC, USB 3.0muxed as pin |
| 108 | USB3_SSTXN | USB 3.0 interface | TYPEC, USB 3.0muxed as pin |
| 109 | USB3_SSRXP | USB 3.0 interface | TYPEC, USB 3.0muxed as pin |
| 110 | USB3_SSRXN | USB 3.0 interface | TYPEC, USB 3.0muxed as pin |
| 111 | TYPEC0_U2VBUSDET | TYPEC interface |  |
| 112 | ADC_IN1 | ADC1inputpin | The reference level is 1.8V |
| 113 | ADC_IN0 | ADC0inputpin | The reference level is 1.8V |
| 114 | USB3_DM | USB 3.0 interface | TYPEC, USB 3.0muxed as pin |
| 115 | USB3_DP | USB 3.0 interface | TYPEC, USB 3.0muxed as pin |
| 116 | HOST0_DM | USB 2.0 interface |  |
| 117 | HOST0_DP | USB 2.0 interface |  |
| 118 | HOST1_DM | USB 2.0 interface |  |
| 119 | HOST1_DP | USB 2.0 interface |  |
| 120 | VCC1V8_S3 | 1.8VPower output | The voltage is 0 during sleep |
...
| 152 | GPIO0_A2/ / RK3399_26M_OUT | GPIO port or 26M clock outputpin |  |
| 153 | GPIO0_B4 | GPIO |  |
| 154 | GPIO0_B5 | GPIO |  |
...
| 170 | GPIO2_B0/ / I2C7_SCL/ / CIF_VSYNC | GPIO or I2C interface or parallel camera interface |  |
| 171 | GPIO2_A7/ / I2C7_SDA/ / CIF_D7 | GPIO or I2C interface or parallel camera interface |  |
...
| 182 | GND | ReferenceGround |  |
| 183 | GPIO3_B6/ / MAC_RXCLK/ / UART3_RX | GPIO or Gigabit Ethernet Interface or UART |  |
...
| 190 | GPIO3_C0/ / MAC_COL/ / UART3_CTSn/ / SPDIF_TX | GPIO or Gigabit Ethernet Interface or UART or fiber optic interface |  |
| 191 | GPIO3_C1/ / MAC_TXCLK/ / UART3_RTSn | GPIO or Gigabit Ethernet Interface or UART |  |
| 192 | GPIO3_B2/ / MAC_RXER/ / I2C5_SDA | GPIO or Gigabit Ethernet Interface or I2C interface |  |
| 193 | GPIO3_B7/ / MAC_CRS/ / UART3_TX | GPIO or Gigabit Ethernet Interface or UART |  |
| 194 | GPIO3_A4/ / MAC_TXD0 / SPI0_TXD | GPIO or Gigabit Ethernet Interface or SPI Interface |  |
| 195 | GPIO3_A5/ / MAC_TXD1/ / SPI0_TXD | GPIO or Gigabit Ethernet Interface or SPI Interface |  |
| 196 | GPIO3_A0/ / MAC_TXD2/ / SPI4_RXD | GPIO or Gigabit Ethernet Interface or SPI Interface |  |
| 197 | GPIO3_A1/ / MAC_TXD3/ / SPI4_TXD | GPIO or Gigabit Ethernet Interface or SPI Interface |  |
| 198 | GPIO3_B4/ / MAC_TXEN/ / UART1_RX | GPIO or Gigabit Ethernet Interface or UART |  |
| 199 | GPIO3_B5/ / MAC_MDIO/ / UART1_TX | GPIO or Gigabit Ethernet Interface or UART |  |
| 200 | GPIO3_B1/ / MAC_RXDV | GPIO or Gigabit Ethernet Interface |  |
