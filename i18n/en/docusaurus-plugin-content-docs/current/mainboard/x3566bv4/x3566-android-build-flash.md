...
description: X3566 Android 11 development environment, source build, image output, and flashing
---

# Android Build and Flash

This page summarizes the development environment, source installation, build process, and flashing flow for X3566 Android.
...
X3566 Android 11 commonly uses Java 8 in the build script:
...
The X3566 Android PDF manual lists:
...
:::note
The uploaded Word version contains an obvious inherited path from another platform: `rk3568-evb1-ddr4-v10.dts`. This template uses the X3566 PDF path `rk3566-rk817-tablet.dts` by default.
:::
...
```text
DVD_X3566&I3566/source/x3566_Android_new
```

Example:

```bash
tar -jxvf x3566_Android 11.tar.bz2
cd x3566_Android 11
git checkout .
```

If the source is split into volumes, extract `prebuilts.tar.bz2` in the `x3566_Android 11` directory.
