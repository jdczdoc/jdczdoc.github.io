...
description: i6818 Android 5.1 environment, source build, boot card, and fastboot flashing
---
...
The i6818 Android manual is based on Android 5.1, with Ubuntu 14.04 64-bit as the example development environment. Because Android source trees are large after Android 4.0, the manual recommends installing Linux directly rather than compiling the full Android tree in a virtual machine.
...
The manual has a dedicated U-Boot environment section. i6818 may require different boot media, bootargs, display parameters, and rootfs parameters when switching among flashing, TF-card boot, eMMC boot, Ubuntu, Android, and Linux.
...
The boot card helps i6818 / iBoi6818 enter flashing or upgrade flow. After creation, insert the TF card and power on according to the manual.
