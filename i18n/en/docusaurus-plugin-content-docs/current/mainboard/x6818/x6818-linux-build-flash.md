...
description: X6818 Linux + Qt build, boot card, fastboot, and image flashing
---

# Linux Build and Flash

The X6818 Linux manual uses an Ubuntu 15.04 virtual machine as the example environment. Linux development requires less PC performance than Android, so VMware is acceptable. Installing Ubuntu directly still provides better build performance.
