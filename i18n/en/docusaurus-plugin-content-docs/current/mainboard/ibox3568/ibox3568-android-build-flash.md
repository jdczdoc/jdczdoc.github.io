...
description: iboibox3568 Android11 source installation, build, and firmware flashing
---
...
This page keeps the content directly related to installing, building, and flashing the iboibox3568 Android11 source tree. Generic Ubuntu installation and Windows XP boot-menu content are not included.
...
- The original manual uses Ubuntu 14.04 / 16.04 64-bit as a reference. For iboibox3568 Android11, follow the actual SDK requirements;
...
Obtain the Android11 source package from the `DVD_iboibox3568/source/` directory, for example:
...
Common images include `MiniLoaderAll.bin`, `U-Boot.img`, `trust.img`, `resource.img`, `boot.img`, `misc.img`, `recovery.img`, `dtbo.img`, `super.img`, and `vbmeta.img`.
...
After the build, files such as `rk356x_spl_loader_v1.03.107.bin`, `U-Boot.img`, and `resource.img` are generated.
