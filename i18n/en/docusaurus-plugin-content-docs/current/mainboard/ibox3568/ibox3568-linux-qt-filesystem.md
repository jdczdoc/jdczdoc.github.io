...
description: iboibox3568 Buildroot, QT filesystem, and MIPI display configuration
---
...
This page summarizes iboibox3568 Linux / QT filesystem content, focusing on Buildroot compilation and the MIPI display configuration entry.

## Buildroot Filesystem

The `build.sh` script in the iboibox3568 Linux SDK integrates the Buildroot rootfs build target:
