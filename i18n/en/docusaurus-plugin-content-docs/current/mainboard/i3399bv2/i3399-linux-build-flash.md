...
description: I3399 Linux SDK download, build, image description, and flashing
---

# Linux Build and Flash

This page is organized from the newer Rockchip Linux SDK manual and keeps the workflow useful for I3399 / X3399.
