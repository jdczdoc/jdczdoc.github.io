---
title: LRADC Configuration
sidebar_position: 2
description: Hardware checks, kernel configuration, Device Tree, build, and DTB validation for LRADC.
---
...
- Allwinner BSP > Device Drivers > Input Drivers > LRADC/Keyboard
- `INPUT`
- `INPUT_EVDEV`
