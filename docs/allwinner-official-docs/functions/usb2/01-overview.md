...
title: USB 2.0 模块概述
sidebar_position: 1
description: USB 2.0 模块功能、适用范围、源码结构和阅读顺序。
---

# USB 2.0 模块概述
本页先明确模块边界和平台差异。后续配置示例以 T527 和 Linux 5.15 为主要参考，但最终属性、路径和宏必须以当前 SDK 分支为准。
## 整理依据
- 原始文档：Linux USB 2.0 开发指南
- 版本：2.7
- 发布日期：2026-01-30
## 适用范围

包含 T527 Linux 5.15/6.6，覆盖 Host、Device、OTG、Gadget、Type-C、PHY、眼图和常见异常。

## 模块能力

- EHCI/OHCI Host、UDC Device 与 OTG manager
- VBUS、ID、Type-C/CC 检测和角色切换
- ConfigFS Gadget 及复合功能
- debugfs、usbmon、寄存器、眼图和驱动能力调节
