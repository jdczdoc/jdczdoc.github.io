...
title: GPIO 模块概述
sidebar_position: 1
description: GPIO 模块功能、适用范围、源码结构和阅读顺序。
---

# GPIO 模块概述
本页先明确模块边界和平台差异。后续配置示例以 T527 和 Linux 5.15 为主要参考，但最终属性、路径和宏必须以当前 SDK 分支为准。
## 整理依据
- 原始文档：Linux GPIO 开发指南
- 版本：2.2
- 发布日期：2026-03-13
## 适用范围

适用于全志 BSP 独立仓库中的 pinctrl/GPIO 驱动；T527 Linux 5.15 可按本文流程定位实际节点和配置。

## 模块能力

- GPIO 输入/输出与电平控制
- pinctrl state、pinmux、pull、drive strength 配置
- GPIO 到中断的映射和中断消抖
- debugfs、sunxi_pinctrl 与用户空间调试
