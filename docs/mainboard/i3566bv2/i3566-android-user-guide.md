...
sidebar_position: 9
title: Android 使用指南
description: I3566 Android 常用功能操作
---
...
本页整理 I3566 Android 系统启动后的常用功能操作。
...
主板支持 CIF/CSI 摄像头，也支持 USB 摄像头。若无图像，应检查摄像头供电、复位、MCLK、I2C、MIPI/并口信号、设备树和驱动。
...
I3566 支持 HDMI 输出。若无显示，应确认 HDMI 线材、显示器输入源、EDID、分辨率和显示驱动配置。
