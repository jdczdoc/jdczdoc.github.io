...
sidebar_position: 9
title: Android 编译与烧录
description: i6818 Android 5.1 开发环境、源码编译、启动卡和 fastboot 烧录
---
...
i6818 Android 平台用户手册基于 Android 5.1，开发环境示例为 Ubuntu 14.04 64 位。由于 Android 4.0 以后源码工程庞大，手册建议不要使用虚拟机完整编译 Android，而是直接安装 Linux 操作系统，以充分利用 PC 性能。
...
手册单独列出 U-Boot 环境变量设置章节。i6818 在烧录、TF 卡启动、eMMC 启动、Ubuntu / Android / Linux 切换时，都可能需要设置启动介质、bootargs、显示参数和根文件系统参数。
...
启动卡用于引导 i6818 / iBoi6818 进入烧录或升级流程。制作完成后，插入 TF 卡，按手册要求上电启动。
