...
sidebar_position: 11
title: Linux QT 文件系统
description: X3568 Buildroot、QT 文件系统和 MIPI 屏配置
---

# Linux QT 文件系统

本页整理 X3568 Linux / QT 文件系统相关内容，重点保留 Buildroot 编译和 MIPI 屏配置入口。

## Buildroot 文件系统

X3568 Linux SDK 的 `build.sh` 脚本已集成 Buildroot rootfs 编译目标：
