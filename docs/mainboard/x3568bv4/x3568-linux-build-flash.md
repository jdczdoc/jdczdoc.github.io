...
sidebar_position: 10
title: Linux 编译与烧录
description: X3568 Linux4.19 源码安装、编译、固件打包和烧录
---

# Linux 编译与烧录

本页保留 X3568 Linux 平台中与源码安装、编译、打包和烧录直接相关的内容。VMware、Ubuntu 安装截图等通用教程不再搬运。

## 开发环境建议

- X3568 Linux 源码编译建议使用 Ubuntu 16.04 / 18.04 64 位环境；
