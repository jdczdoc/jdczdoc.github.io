...
sidebar_position: 10
title: Linux 编译与烧录
description: I3399 Linux SDK 获取、编译、镜像说明和固件烧录
---

# Linux 编译与烧录

本页按照新版 Rockchip Linux SDK 手册整理，保留 I3399 / X3399 常用的 SDK 获取、编译、镜像说明和烧录流程。
...
烧录需要主板处于 Loader 或 Maskrom 模式。常见方式：
...
新版 Linux 手册也包含 TF 卡升级流程。一般步骤为：准备升级卡工具、选择固件、制作升级卡、插入主板并按升级流程启动。量产或现场维护时可按项目需求选择。
