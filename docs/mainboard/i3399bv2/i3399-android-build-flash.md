...
sidebar_position: 7
title: Android 编译与烧录
description: I3399 Android 7.1 开发工具、源码安装、编译和固件烧录
---

# Android 编译与烧录

本页保留 I3399 / X3399 Android 7.1 平台与编译、烧写直接相关的内容。通用的 Ubuntu U 盘安装、XP 启动项等系统教程不再搬运。
...
完整编译后生成单包升级固件 `update-android.img`，通常位于 SDK 输出目录或 `rockdev/Image-*` 目录。烧录前需确认分区文件、loader、uboot、boot、system 等镜像与硬件版本一致。
