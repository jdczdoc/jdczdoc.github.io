...
sidebar_position: 9
title: Linux 编译与烧录
description: X6818 Linux + Qt 编译、启动卡、fastboot 和镜像烧写
---

# Linux 编译与烧录

X6818 Linux 平台用户手册以 Ubuntu 15.04 虚拟机环境为例。Linux 开发对 PC 性能要求低于 Android，因此可使用 VMware 虚拟机；如果直接安装 Ubuntu，编译效率会更高。
